...
public partial class GridManager : Node
{
	...
	private bool IsTileInsideCircle(Vector2 centerPos, Vector2 tilePos, float radius)
	{
		var distanceX = centerPos.X - (tilePos.X + .5);
		var distanceY = centerPos.Y - (tilePos.Y + .5);
